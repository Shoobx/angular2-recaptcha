...
var ReCaptchaComponent = /** @class */ (function () {
    ...
    ReCaptchaComponent.prototype.reset = function () {
        ...
        this._zone.runOutsideAngular(window.grecaptcha.reset.bind(this.widgetId));
        this.onChange(null);
    };
    // noinspection JSUnusedGlobalSymbols
    ...
    ], ReCaptchaComponent.prototype, "global", void 0);
    __decorate([
        core_1.Output(),
        __metadata("design:type", Object)
    ...
    __decorate([
        core_1.Output(),
        __metadata("design:type", Object)
    ], ReCaptchaComponent.prototype, "loaded", void 0);
    __decorate([
