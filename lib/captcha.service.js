...
var ReCaptchaService = /** @class */ (function () {
    function ReCaptchaService(zone) {
        ...
        if (typeof window != 'undefined') {
            window["reCaptchaOnloadCallback"] = (function () { return zone.runOutsideAngular(_this.onloadCallback.bind(_this)); });
        }
    }
    ReCaptchaService.prototype.getReady = function (language, global) {
        if (!this.scriptLoaded) {
            var scriptUrl = !!global ? 'www.recaptcha.net' : 'www.google.com';
